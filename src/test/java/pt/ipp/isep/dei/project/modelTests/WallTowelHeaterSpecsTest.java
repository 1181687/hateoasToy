...
public class WallTowelHeaterSpecsTest {
    ...
    public void StartUp() {
        ...
        this.wallTowelHeater = wallTowelHeaterType.createDevice("aquecedor");
        kitchen.addDevice(wallTowelHeater);
        this.wallTowelHeater.setAttributesDevType(ATTRIBUTE_NOMINAL_POWER, 100);
        this.wallTowelHeater.setAttributesDevType(ATTRIBUTE_TIME, 10);
