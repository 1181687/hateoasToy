...
public class US3ControllerTest {
    ...
    public void testarAdicionarNovaAG() {
        ...
        GeographicArea ag = new GeographicArea(nomeAG, tipo, local, area);
        //Act
    ...
    public void testarGetListaTAG() {
        ...
        Location local = new Location(41.1496, -8.6109, 97);
        RectangleArea area = new RectangleArea(10, 10,local);
        GeographicArea areaDaLista = new GeographicArea(nomeAG, tipo, local, area);
    ...
    public void testarCriarNovaAG() {
        ...
        RectangleArea area = new RectangleArea(10, 10, local);
        GeographicArea expectedResult = new GeographicArea(nomeAG, tipo, local, area);

        GeographicArea result = ctrl3.criarNovaAG("Porto", "Cidade", 40.5,
                50.5, 100.0, 10, 10);
        //Act
