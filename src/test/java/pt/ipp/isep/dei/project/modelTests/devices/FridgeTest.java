...
public class FridgeTest {
    ...
    public void StartUp() {
        ...
        // Dummy fridge
        Device dummyFridge = fridgeType.createDevice("Miele PerfectCool Series 1000");

        // fridge
        fridge = fridgeType.createDevice("Miele PerfectCool Series 3500");
        fridge.setLocation(kitchen);
        dummyFridge.setLocation(kitchen);
    ...
    public void testGetReadings() {
        ...
        //Act
        List<DeviceReading> result = fridge.getReadings();
    ...
    public void setNameWithSameLocationTestFridge1() {
        Throwable exception = assertThrows(RuntimeException.class, () -> kitchen.getDevice("Miele PerfectCool Series 1000").setName("Miele PerfectCool Series 3500"));
        assertEquals("Name already exists. Please write a new one.", exception.getMessage());
    }

    @Test
    public void setNameWithSameLocationTestFridge2() {
        Throwable exception = assertThrows(RuntimeException.class, () -> kitchen.getDevice("Miele PerfectCool Series 3500").setName("Miele PerfectCool Series 1000"));
        assertEquals("Name already exists. Please write a new one.", exception.getMessage());
    }
