...
class LampTest {
    ...
    public void StartUp() {
        ...
        Device dummyLamp = lampType.createDevice("TaoTronics Elune TT-DL01");
        lamp = lampType.createDevice("TaoTronics Elune TT-DL02");
        lamp.setLocation(kitchen);
        dummyLamp.setLocation(kitchen);
    ...
    public void testGetReadings() {
        ...
        //Act
        List<DeviceReading> result = lamp.getReadings();
