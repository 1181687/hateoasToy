...
public class WashingMachineTest {
    ...
    public void StartUp() {
        ...
        Device dummyWashingMachine = washingMachineType.createDevice("Maytag 2.6");
        washingMachine = washingMachineType.createDevice("Maytag 3.6");
        washingMachine.setLocation(kitchen);
        dummyWashingMachine.setLocation(kitchen);
        ...
        DeviceReading reading0 = new DeviceReading(3, time0);
        LocalDateTime time1 = LocalDateTime.of(2019, 01, 24, 8, 00, 00);
        DeviceReading reading1 = new DeviceReading(5, time1);
        LocalDateTime time2 = LocalDateTime.of(2019, 01, 24, 16, 00, 00);
        DeviceReading reading2 = new DeviceReading(7, time2);
