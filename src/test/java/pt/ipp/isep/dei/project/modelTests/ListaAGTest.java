...
public class ListaAGTest {
    ...
    void testaAdicionarAreaGeoAListaPositivo() {
        ...
        GeographicArea geographicArea = new GeographicArea(nomeAG, tipo, local, area);

        //Act
        boolean resultado = lista.adicionarAreaGeoALista(geographicArea);
    ...
    void testaAdicionarAreaGeoAListaNegativo() {
        ...
        ListaAG lista = new ListaAG();
        GeographicArea geographicArea = new GeographicArea(nomeAG, tipo, local, area);
        lista.adicionarAreaGeoALista(geographicArea);
    ...
    public void getmListaAG() {
        ...
        expectedResult.add(geographicArea);

        List<GeographicArea> resultado = lista.getmListaAG();
    ...
    public void testarGetAreaGeograficaNaListaApresentada() {
        ...
        //Act
        GeographicArea resultado = lista.getAreaGeograficaNaListaApresentada(opçãoSeleccionada);
    ...
    public void testarGetAreaGeograficaComResultadoNull() {
        ...
        //Act
        GeographicArea resultado = lista.getAreaGeografica(ag2);
    ...
    public void testarNovaAreaGeografica() {
        ...
        RectangleArea area = new RectangleArea(10, 10, local);
        GeographicArea resultado = new GeographicArea(nomeAG, tipo, local, area);

        GeographicArea expectedResult = lista.novaAreaGeografica("Porto", "Cidade", 40.5, 50.5, 100.0, 10, 10);
        //Act
