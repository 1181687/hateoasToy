...
public class ElectricWaterHeaterTest {
    ...
    public void StartUp() {
        ...
        Device dummyElectricWaterHeater = electricWaterHeaterType.createDevice("Bosch Tronic 2000");
        electricWaterHeater = electricWaterHeaterType.createDevice("Bosch Tronic 3000");
        electricWaterHeater.setLocation(kitchen);
        dummyElectricWaterHeater.setLocation(kitchen);
    ...
    public void testGetReadings() {
        ...
        //Act
        List<DeviceReading> result = electricWaterHeater.getReadings();
