...
public class MeasurableList {
    private Set<Measurable> measurableObjectsList = new HashSet<>();
    ...
    public void addMeasurable(Measurable measurable) {
        this.measurableObjectsList.add(measurable);
    }
    ...
    public double getNominalPower() {
        ...
        for (Measurable measurable : this.measurableObjectsList) {
    ...
    public boolean checkIfMeasurableObjIsInList(Measurable measurable) {
        return this.measurableObjectsList.contains(measurable);
    }
