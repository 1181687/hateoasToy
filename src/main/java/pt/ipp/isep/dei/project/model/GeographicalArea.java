...
public class GeographicalArea {
    ...
    public SensorList getTheSensorListOfAGivenType(SensorType type) {
        ...
        listOfSensors.setSensorList(getSensorsInGeographicalAreaByType(type).getSensorList());
        while (listOfSensors.getSensorList().isEmpty()) {
            if (areaToBeUsed.getInsertedIn() != null) {
                ...
                listOfSensors.setSensorList(areaToBeUsed.getSensorListInTheGeographicArea().getSensorList());
            } else {
