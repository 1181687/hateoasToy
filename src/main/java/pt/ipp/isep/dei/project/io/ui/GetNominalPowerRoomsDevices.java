...
public class GetNominalPowerRoomsDevices {
    ...
    public void run() {
        ...
        System.out.println("The total nominal power for the selected subset of rooms and/or devices is " + mController.getNominalPowerOfSelectedMeasurableObjects() + " kW\n");
    }
}